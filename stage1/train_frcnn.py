...
# Original epoch number was 2000. For performance characterization, we used ~50 epochs in order to train in a reasonable amount of time.
...
#epoch_length = 1000 this is the original epoch length.
epoch_length = 1000 # set to 10 for testing purposes
...
print(train_loss)
np.savetxt("train_loss",train_loss,delimiter=',')
np.savetxt("val_loss",val_loss,delimiter=',')
